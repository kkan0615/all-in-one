  ...
  <div>
    ...
    >
      <v-card-text>
        ...
        <!--          &lt;!&ndash;              v-model="selectedTestType[0]"&ndash;&gt;-->
        <!--          &lt;!&ndash;              label="To role"&ndash;&gt;-->
        <!--          &lt;!&ndash;            />&ndash;&gt;-->
        <!--          &lt;!&ndash;          </v-col>&ndash;&gt;-->
        <!--          &lt;!&ndash;          <v-col>&ndash;&gt;-->
        <!--          &lt;!&ndash;            <v-checkbox&ndash;&gt;-->
        <!--          &lt;!&ndash;              v-model="selectedTestType[1]"&ndash;&gt;-->
        <!--          &lt;!&ndash;              label="To User"&ndash;&gt;-->
        <!--          &lt;!&ndash;            />&ndash;&gt;-->
        <!--          &lt;!&ndash;          </v-col>&ndash;&gt;-->
        <!--          &lt;!&ndash;          <v-col>&ndash;&gt;-->
        <!--          &lt;!&ndash;            <v-checkbox&ndash;&gt;-->
        <!--          &lt;!&ndash;              v-model="selectedTestType[2]"&ndash;&gt;-->
        <!--          &lt;!&ndash;              label="To Every one"&ndash;&gt;-->
        <!--          &lt;!&ndash;            />&ndash;&gt;-->
        <!--          &lt;!&ndash;          </v-col>&ndash;&gt;-->
        <!--          <v-col-->
